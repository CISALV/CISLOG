...
function TMunicipioDAO.GetMunicipioByID(MunicipioID: Integer): TMunicipio;
var
  Query: TFDQuery;
begin
...
function TMunicipioDAO.GetMunicipios: TFDQuery;
begin
...
function TMunicipioDAO.Gravar(AMunicipio: TMunicipio): Integer;
var
...
function TMunicipioDAO.ProcurarMunicipios(const FilterField, FilterValue: string): TFDQuery;
begin
     Result := TDataConService.GetInstance.GetQuery;
     Result.Close;
     Result.SQL.Clear;
...
function TMunicipioDAO.Alterar(AMunicipio: TMunicipio): Integer;
var
  DataCon: TDataConService;
  Connection: TFDConnection;
  StoredProc: TFDStoredProc;
...
function TMunicipioDAO.Excluir(AId: Integer): Integer;
var
  DataCon : TDataConService;
  Connection : TFDConnection;
  StoredProc : TFDStoredProc;
